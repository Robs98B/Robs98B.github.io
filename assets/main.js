...
const translations = {
  en: {
    ...
    bio_title: "About Me",
    bio_text: "I am a PhD student in Theoretical and Applied Neuroscience at the Department of Biomedical and Neuromotor Sciences, University of Bologna. I hold a master’s degree in Artificial Intelligence, and my current research sits at the intersection of AI and neuroscience. I use machine learning, deep learning, and signal processing methods to investigate neural encoding and decoding, and to translate these insights into practical applications through brain–computer interfaces.",
  ...
  it: {
    ...
    bio_title: "Chi Sono",
    bio_text: "Sono un dottorando in Neuroscienze Teoriche e Applicate presso il Dipartimento di Scienze Biomediche e Neuromotorie dell’Università di Bologna. Arrivo da una laurea magistrale in Intelligenza Artificiale e oggi lavoro proprio nel punto in cui AI e neuroscienze si incontrano. Mi occupo di machine learning, deep learning ed elaborazione del segnale per capire meglio come il cervello codifica e decodifica le informazioni e per trasformare queste conoscenze in applicazioni concrete, in particolare nel campo delle interfacce cervello–computer.",
